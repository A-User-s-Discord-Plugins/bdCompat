module.exports = class AddonAPI {
    constructor(list, manager) {
        ...
        this.enable = this.manager.enable && this.manager.enable.bind(this.manager)  || (() => {})
        this.disable = this.manager.disable && this.manager.disable.bind(this.manager) || (() => {})
        this.reload = this.manager.reload && this.manager.reload.bind(this.manager)  || (() => {})
    }
